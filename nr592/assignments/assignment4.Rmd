...
These data were converted and "tidied" from a Word document table in Table S1 of the article's supporting information: https://journals.plos.org/plosone/article?id=10.1371/journal.pone.0113505#s5

In addition, time-lagged versions of three variables (`cattleDepredated`, `sheepDepredated`, and `wolvesKilled`) were added to the CSV. Each of these variables were shifted forward one year, so that their values represent those of their respective variables for the previous year.
