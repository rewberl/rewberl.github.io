...
1. Ecological community data  
    ...
    d. Principal component analysis, Principal component plot  
    e. Cluster analysis, Silhouette plot, and Cluster plot  
2. Likert survey data  
    ...
    b. Principal component analysis, Principal component plot  
    c. Cluster analysis, Silhouette plot, and Cluster plot  
3. Network data  
    a. Two descriptive statistics (e.g. centrality, diameter, distance, edge density), Network visualization, Community detection  
4. Geospatial data  
    a. Geospatial plot  
        i. Note: Must include basemap layer and at least one layer of shapefiles of your choice  
