...
**Section**  
Seminar in Natural Resources (NR 592, Section 1)  
1 course credit
...
**Texts and Resources**  
There are no required texts. We will use a variety of freely-available online resources and the occasional academic paper. Please refer to the [Course Schedule](./schedule_spring2019.html) for links to required weekly readings.

You are encouraged to seek additional information on your own, especially to go into more depth on the concepts covered in this course or to explore additional topics of interest to you. Some useful general resources are listed below. In addition, resources specific to each week's topics are listed on the [Course Schedule](./schedule_spring2019.html).
...
* Venables, W. N., et al. An introduction to R. Available: https://colinfay.me/intro-to-r/
...
Required reading should be done by the second class meeting of the week (Thursday) in which it is listed.
