...
1. **Required Reading**  
    ...
    a. Wickham, H. Welcome through Section 3: Functions. In _The tidyverse style guide_. Available: https://style.tidyverse.org/
        ...
        * Skim and refer back later when writing scripts
...
* Bryan, J., et al. Happy Git and GitHub for the useR. Available: https://happygitwithr.com/index.html
...
1. **Required Reading**  
    ...
    a. Tukey, J. W. (1977). Preface. In _Exploratory data analysis_ (pp. v-ix). Reading, MA: Addison-Wesley. Available: [here](/materials/tukey1977preface.pdf)
...
1. **Required Reading**  
    ...
    a. Wilke, C. O. Telling a story and making a point. In _Fundamentals of data visualization_. Available: https://serialmentor.com/dataviz/telling-a-story.html
